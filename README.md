...
4. **Deploy**: Vercel will automatically detect the React configuration and deploy the app to a global CDN.
...
- **AI Explainability**: Real-time narrative generation using Gemini 3.5 Pro to explain "Black Box" decisions to human analysts.
